...
export class RouteCalculator extends PathCalculator{
    /**
    ...
    public getPawnRoute(square: Square): Path
    {
        ...
        return {
            ...this.getVerticalSquares(square, 2),
            ...this.getDiagonalSquares(square, 1)
        }
    }
    ...
    public getKnightRoute(square: Square): Array<Square>
    {
        ...
        const firstPath = {
            ...this.getVerticalSquares(square, 2, false),
            ...this.getHorizontalSquares(square, 2, false)
        }
    ...
    public getBishopRoute(square: Square): Path
    {
        ...
        return this.getDiagonalSquares(square);
    }
    ...
    public getRookRoute(square: Square): Path
    {
        ...
        return {
            ...this.getHorizontalSquares(square),
            ...this.getVerticalSquares(square)
        };
    }
    ...
    public getQueenRoute(square: Square): Path
    {
        ...
        return {
            ...this.getHorizontalSquares(square),
            ...this.getVerticalSquares(square),
            ...this.getDiagonalSquares(square)
        };
    }
    ...
    public getKingRoute(square: Square): Path
    {
        ...
        return {
            ...this.getHorizontalSquares(square, 1),
            ...this.getVerticalSquares(square, 1),
            ...this.getDiagonalSquares(square, 1)
        };
    }
}