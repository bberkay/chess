...
export enum StartPosition{
    ...
    WhiteCastling = "r3k2r/8/8/4b3/4B3/8/8/R3K2R w KQkq - 0 1",
    BlackCastling = "r3k2r/8/8/4b3/4B3/8/8/R3K2R b KQkq - 0 1",
    ...
    DoubleCheck = "rnbqkbnr/pppppNpp/8/7Q/8/8/PPPPPPPP/RNB1KB1R w KQkq - 0 1",
